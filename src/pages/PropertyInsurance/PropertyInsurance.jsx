    ...
    >
      <Box className="container" sx={{ maxWidth: '1200px', mx: 'auto', px: 2 }}>
        <Box sx={{ 
          ...
          <PolisBuilder 
            params="ZmlsdGVycyU1QmZpbmlzaGluZyU1RD0xNTAwMDAmZmlsdGVycyU1Qm1vdmFibGUlNUQ9MTUwMDAwJmZpbHRlcnMlNUJjaXZpbF9saWFiaWxpdHklNUQ9MTUwMDAwJnR5cGU9ZmxhdA=="
            whiteLabel="true"
            type="flat"
        ...
        <Box sx={{ mt: 4, mb: 4 }}>
          <Chat 
            title="Есть вопросы по страхованию недвижимости?"
