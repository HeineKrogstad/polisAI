...
export default function AcarusInsurancePage() {
  return (
    <Box 
      sx={{ 
        minHeight: '100vh',
    ...
    >
      <Box className="container" sx={{ maxWidth: '1200px', mx: 'auto', px: 2 }}>
        <Box sx={{ 
          ...
          <PolisBuilder 
            params="YWdlJTVCJTVEPTMwJmFkdWx0XzU5PTE="
            whiteLabel="true"
            type="antimite"
            title="Страхование от укуса клещей"
        ...
        <Box sx={{ mt: 4, mb: 4 }}>
          <Chat 
            title="Есть вопросы по страхованию от клещей?"
